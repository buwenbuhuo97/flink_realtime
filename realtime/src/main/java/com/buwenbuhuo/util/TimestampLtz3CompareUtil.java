...
public class TimestampLtz3CompareUtil {
    public static int compare(String timestamp1, String timestamp2) {
        /**
         * TODO 数据格式 2022-04-01 10:20:47.302Z
         */
        // TODO 1. 去除末尾的时区标志，'Z' 表示 0 时区
        ...
        // TODO 3. 提取 yyyy-MM-dd HH:mm:ss 的部分
    ...
    public static void main(String[] args) {
        System.out.println(
                compare("2022-04-01 11:10:55.040Z",
                        "2022-04-01 11:10:55.04Z"));

        System.out.println(
                compare("2022-04-01 11:10:55.040Z",
                        "2022-04-01 11:10:55.045Z"));

        System.out.println(
                compare("2022-04-01 11:10:55.045Z",
                        "2022-04-01 11:10:55.04Z"));
    }
}
