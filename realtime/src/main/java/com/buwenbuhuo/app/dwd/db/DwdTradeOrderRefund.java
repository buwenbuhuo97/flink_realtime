...
import com.buwenbuhuo.bean.OrderInfoRefundBean;
...
public class DwdTradeOrderRefund {
    public static void main(String[] args) throws Exception {
        ...
        tableEnv.executeSql("create table topic_db(" +
                ...
                "`ts` string " +
                ")" + MyKafkaUtil.getKafkaDDL("topic_db", "dwd_trade_order_refund_app"));
        ...
        // TODO 9. 建立 Upsert-Kafka dwd_trade_order_refund 表
